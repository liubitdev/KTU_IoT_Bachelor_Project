...
set APP_NAME=openHAB
set APP_LONG_NAME=openHAB
set APP_BASE=C:\Users\Admin\Downloads\openhab-3.0.1\userdata
set APP_ETC=C:\Users\Admin\Downloads\openhab-3.0.1\userdata\etc
